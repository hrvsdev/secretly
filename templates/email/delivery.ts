const deliveryTemp = (link: string, message?: string) => {
  ...
  <main style="background: white;padding: 30px 20px;max-width: 600px;margin: auto;text-align: center;border-radius: 10px;">
    ...
    <a href="${link}" style="text-decoration: none;"><button style="border: 0;outline: 0;height: 48px;color: #ffffff;background-color: #0072f5;border-radius: 10px;padding: 0 40px;margin: 20px 0;will-change: transform;transition: all 0.25s;">View Secret</button></a>
